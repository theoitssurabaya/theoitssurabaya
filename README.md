...
I am a **Computer Engineering** student at **Institut Teknologi Sepuluh Nopember (ITS)** with a deep passion for bridging the gap between hardware and intelligence. My work focuses on **Internet of Things (IoT)**, **Embedded Systems**, and **Edge AI**.

---

### 🛠 Tech Stack:
- **Languages:** Python (Scikit-Learn, PyTorch, NumPy), C++ (Arduino/PlatformIO), Dart (Flutter), SQL.
- **Hardware:** ESP32, Raspberry Pi, PZEM-004T, Ultrasonic & Load Cell Sensors.
